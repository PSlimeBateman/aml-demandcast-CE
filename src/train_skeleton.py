"""
SPLIT THE DATA, CREATING THE FUNCTIONS, THE DIFFERENT METRICS WE LOG INTO MLFLOW, A build_train.py THAT HAS A SIMILAR
STRUCTURE TO build_features.py 
...
def evaluate(y_true: pd.Series, y_pred: np.ndarray) -> dict[str, float]:
    ...
    return {
        ...
        "rmse": round(root_mean_squared_error(y_true, y_pred), 4), # high value means model isn't doing a good job with outliers or extremes
